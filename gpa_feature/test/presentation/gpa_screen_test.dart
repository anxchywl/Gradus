...
import 'package:gpa_feature/src/presentation/course_form.dart';
import 'package:gpa_feature/src/presentation/gpa_responsive.dart';
import 'package:gpa_feature/src/presentation/gpa_widgets.dart';
...
void main() {
  ...
  group('courses', () {
    ...
    testWidgets('a pass/fail course is labelled rather than looking lost', (
      ...
      expect(find.text('4.00'), findsWidgets);
      expect(find.byType(GpaStatusChip), findsOneWidget);
  ...
  group('layout', () {
    ...
    testWidgets('the reading column stops growing on a wide window', (
      ...
      expect(
        card.width,
        lessThanOrEqualTo(gpaReadingWidth),
