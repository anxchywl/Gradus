...
import 'package:gpa_feature/src/presentation/assignment_form.dart';
...
Widget _host(
  ...
  home: GpaFeature(
    session: const GpaSession(accessToken: 'a-token', accountId: 'student-1'),
...
void main() {
  ...
  testWidgets('an assignment can be left ungraded', (tester) async {
    ...
    expect(find.byType(GpaStatusChip), findsWidgets);
  });
