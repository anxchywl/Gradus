              ...
              CenteredContent(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    GpaSectionHeader(title: strings.assignmentsTitle),
...
class _CourseSummary extends StatelessWidget {
  ...
  List<Widget> _chips(GpaStrings strings) => [
    if (resolved.assignmentCount == 0)
      GpaStatusChip(label: strings.noAssignments, icon: AppIcons.info)
    else if (!resolved.hasGradedWork)
      GpaStatusChip(label: strings.noGradedAssignments, icon: AppIcons.info)
    else if (resolved.isSetupComplete)
      GpaStatusChip(label: strings.setupComplete, icon: AppIcons.checkCircle)
    else
      GpaStatusChip(
